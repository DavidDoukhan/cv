...
%%% opensource
\newcommand{\OpenSec}{Logiciels Open-Source (sélection)}
\newcommand{\OpenMain}{(auteur principal)}
\newcommand{\OpenContrib}{(contributeur)}
...
\newcommand{\PubBook}{Chapitres de livres}
